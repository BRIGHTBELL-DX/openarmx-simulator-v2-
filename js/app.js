...
const PHRASE_DB = {
  ...
  'PH-034': { name: '크랩 핸드 셔플', poses: ['P-303','P-305','P-307','P-309','P-311','P-312','P-310','P-308','P-306','P-304'], dur: 0.34 },
  'PH-035': { name: '락킹 투포인트', poses: ['P-383','P-385','P-387','P-389','P-391','P-393','P-395','P-397','P-399','P-401','P-402','P-400','P-398','P-396','P-394','P-392'], dur: 0.30 },
};
