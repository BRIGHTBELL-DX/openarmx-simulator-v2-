...
const PHRASE_DB = {
  ...
  'PH-041': { name: '아이돌 포인트 체인', poses: ['P-283','P-285','P-287','P-289','P-291','P-292','P-290','P-288','P-286','P-284','P-283','P-284','P-286','P-288','P-290','P-292','P-291','P-289','P-287','P-285','P-283'], dur: 0.27 },
    // ── 팝핀 계열 신규 구: 정면 손목 스냅 / 한손 팝 / 좌우 전달 ───────────────
  // PH-042: 정면으로 팔을 뻗은 상태에서 양손 손목만 짧게 튕기는 기본 팝핀
  'PH-042': { name: '정면 팝핀 베이스', poses: ['P-477','P-478','P-479','P-477','P-482'], dur: 0.16 },

  // PH-043: L7/R7 반전값을 활용해 같은 정면 자세에서 손목 결을 반대로 찍는 팝핀
  'PH-043': { name: '반전 손목 팝', poses: ['P-477','P-493','P-494','P-493','P-504'], dur: 0.15 },

  // PH-044: 왼손만 살아나고 오른손은 정면 유지. 한손 팝핀 느낌
  'PH-044': { name: '왼손 단독 팝', poses: ['P-483','P-484','P-485','P-484','P-492'], dur: 0.14 },

  // PH-045: 오른손만 살아나고 왼손은 정면 유지. 반대쪽 한손 팝핀
  'PH-045': { name: '오른손 단독 팝', poses: ['P-483','P-486','P-487','P-486','P-492'], dur: 0.14 },

  // PH-046: 왼손 팝에서 오른손 팝으로 넘어가는 손목 전달 동작
  'PH-046': { name: '좌우 팝 전달', poses: ['P-477','P-484','P-488','P-486','P-489','P-492'], dur: 0.13 },

  // PH-047: 오른손 팝에서 왼손 팝으로 넘어가는 반대 방향 전달 동작
  'PH-047': { name: '우좌 팝 전달', poses: ['P-477','P-486','P-489','P-484','P-488','P-492'], dur: 0.13 },

  // PH-048: 팔은 정면에 두고 L2/R2 변화로 살짝 밀고 당기는 리바운드 팝핀
  'PH-048': { name: '푸시풀 프론트 팝', poses: ['P-477','P-495','P-496','P-495','P-504'], dur: 0.15 },

  // PH-049: 왼팔은 유지하고 오른손만 팝. 한쪽 팔 고정 테스트용
  'PH-049': { name: '좌고정 우팝', poses: ['P-477','P-497','P-498','P-497','P-504'], dur: 0.14 },

  // PH-050: 오른팔은 유지하고 왼손만 팝. 한쪽 팔 고정 테스트용
  'PH-050': { name: '우고정 좌팝', poses: ['P-477','P-499','P-500','P-499','P-504'], dur: 0.14 },

  // PH-051: 좌우 단독 팝을 짧게 주고 마지막에 양손 히트로 모으는 구성
  'PH-051': { name: '단손 팝 합체', poses: ['P-484','P-485','P-486','P-487','P-490','P-491','P-492'], dur: 0.13 },

  // PH-052: 양손으로 강하게 찍고 풀어주는 엔딩용 팝핀 히트
  'PH-052': { name: '더블 팝 히트', poses: ['P-477','P-490','P-491','P-490','P-492','P-504'], dur: 0.15 },

  // PH-053: 손목 반전 → 한손 팝 → 양손 히트까지 이어지는 짧은 팝핀 루프
  'PH-053': { name: '팝핀 쇼트 루프', poses: ['P-477','P-493','P-484','P-488','P-486','P-489','P-490','P-491','P-492'], dur: 0.12 },

  // PH-054: 정면 유지 상태에서 좌우 한손 팝을 번갈아 반복하는 빠른 루프
  'PH-054': { name: '원핸드 팝 루프', poses: ['P-483','P-484','P-485','P-483','P-486','P-487','P-483','P-490','P-492'], dur: 0.12 },
};
