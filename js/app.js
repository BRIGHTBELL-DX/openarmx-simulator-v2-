...
const PHRASE_DB = {
  ...
  'PH-021': { name: 'X 크로스 스위치',  poses: ['P-191','P-188','P-191','P-189','P-191','P-188','P-191','P-189'], dur: 0.5  },
  // PH-022: 중립 → 교차 → 중립을 빠르게 반복하는 팝 동작
  'PH-022': { name: '교차 팝',          poses: ['P-001','P-191','P-001','P-188','P-001','P-189','P-001','P-191'], dur: 0.4  },
  // PH-023: 팔을 높이 올린 상태에서 X자로 교차 (고공 크로스)
  'PH-023': { name: '고공 X 크로스',    poses: ['P-002','P-194','P-196','P-200','P-196','P-194','P-002','P-196'], dur: 0.65 },
  // PH-024: 한 팔씩 강하게 안쪽으로 지르는 교차 타격 (점층적 강도)
  'PH-024': { name: '교차 타격',        poses: ['P-203','P-204','P-207','P-208','P-211','P-212','P-207','P-208'], dur: 0.5  },
  ...
  'PH-026': { name: '닌자 핸드사인 팝', poses: ['P-181','P-184','P-191','P-186','P-187','P-192','P-190','P-191','P-184'], dur: 0.32 },
  ...
  'PH-036': { name: '나루토 암 러시', poses: ['P-169','P-170','P-171','P-172','P-173','P-172','P-171','P-170','P-169','P-174','P-175','P-176','P-178','P-177','P-178','P-176','P-175','P-174'], dur: 0.30 },
  ...
  // ── 팝핀 계열 정리 구: 유사 포즈 제외 / L7,R7 0값 기반 완충형 ───────────────
    // ── 팝핀 + 애교 리액션 계열 수정 구: PH-042 ~ PH-054 전체 교체 ───────────────

  // PH-042: 손목이 0에서 시작해 단계적으로 커졌다가 다시 풀리는 가장 기본 팝핀
  'PH-042': { name: '정면 팝핀 램프', poses: ['P-505','P-506','P-507','P-508','P-507','P-506','P-505'], dur: 0.20 },

  // PH-043: 매번 베이스로 리셋하면서 손목 히트를 찍는 팝핀. PH-042보다 끊어치는 느낌
  'PH-043': { name: '정면 팝핀 스텝 히트', poses: ['P-505','P-506','P-505','P-507','P-505','P-508','P-507','P-506','P-505'], dur: 0.17 },

  // PH-044: 왼손만 팝을 치고 오른팔은 정면 유지. 단손 포인트용
  'PH-044': { name: '왼손 단독 팝', poses: ['P-505','P-484','P-485','P-484','P-505','P-506','P-505'], dur: 0.20 },

  // PH-045: 오른손만 팝을 치고 왼팔은 정면 유지. PH-044의 반대 버전
  'PH-045': { name: '오른손 단독 팝', poses: ['P-505','P-486','P-487','P-486','P-505','P-506','P-505'], dur: 0.20 },

  // PH-046: 왼손에서 오른손으로 팝이 넘어가는 전달 동작. 중간 브리지 포함
  'PH-046': { name: '좌우 팝 전달', poses: ['P-505','P-484','P-488','P-505','P-486','P-489','P-505'], dur: 0.19 },

  // PH-047: 오른손에서 왼손으로 되돌아오는 반대 방향 전달 동작
  'PH-047': { name: '우좌 팝 전달', poses: ['P-505','P-486','P-489','P-505','P-484','P-488','P-505'], dur: 0.19 },

  // PH-048: L2/R2 변화로 팔 전체가 살짝 밀고 당겨지는 팝핀. 손목만 쓰는 구와 차별화
  'PH-048': { name: '푸시풀 프론트 팝', poses: ['P-505','P-495','P-496','P-495','P-505','P-507','P-505'], dur: 0.21 },

  // PH-049: 한쪽 팔은 유지하고 반대쪽만 팝. 좌우 고정형을 한 구 안에서 모두 테스트
  'PH-049': { name: '원암 홀드 팝', poses: ['P-505','P-497','P-498','P-505','P-499','P-500','P-505'], dur: 0.20 },

  // PH-050: 양손을 동시에 강하게 찍는 포인트. 후렴 강박이나 효과음용
  'PH-050': { name: '더블 팝 히트', poses: ['P-505','P-506','P-490','P-491','P-490','P-507','P-505'], dur: 0.19 },

  // PH-051: 정면 팝핀에서 몸 안쪽 X크로스로 들어갔다가 다시 풀리는 연결 동작
  'PH-051': { name: '팝핀 투 X크로스', poses: ['P-505','P-506','P-507','P-169','P-172','P-175','P-176','P-505'], dur: 0.24 },
  ...
  // PH-059: 애교 포즈에서 정면 팝핀 램프로 넘어가는 연결 동작
  'PH-059': { name: '애교 투 팝핀', poses: ['P-527','P-517','P-519','P-520','P-528','P-505','P-506','P-507','P-508','P-505'], dur: 0.24 },
