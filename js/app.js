...
const PHRASE_DB = {
  ...
  'PH-003': { name: '만세 올리기', poses: ['P-001','P-002','P-041','P-071','P-145','P-153','P-156','P-160'], dur: 0.55 },
  'PH-004': { name: '만세 내리기', poses: ['P-160','P-156','P-153','P-145','P-071','P-041','P-002','P-001'], dur: 0.55 },
  ...
  'PH-007': { name: '사이드 스웨이', poses: ['P-081','P-083','P-085','P-087','P-086','P-084','P-082','P-081'], dur: 0.5 },
  ...
  'PH-014': { name: '풍차 돌리기', poses: ['P-023','P-029','P-035','P-036','P-030','P-024','P-028','P-030','P-036','P-035','P-029','P-027'], dur: 0.32 },
  ...
  'PH-020': { name: '파워 펌프',        poses: ['P-001','P-035','P-001','P-036','P-001','P-035','P-001','P-036'], dur: 0.6  },

  // ── 교차(X) 구 ── 정면에서 팔이 안으로 들어오거나 X자로 겹치는 동작 ─────
  // PH-021: 대칭 X 자세(P-191)를 중심으로 왼팔·오른팔이 번갈아 앞에 오는 크로스 스위치
  'PH-021': { name: 'X 크로스 스위치 안전', poses: ['P-192','P-188','P-192','P-189','P-192','P-191','P-192','P-528'], dur: 0.46 },
  // PH-022: 중립 → 교차 → 중립을 빠르게 반복하는 팝 동작
  'PH-022': { name: '교차 팝 안전', poses: ['P-001','P-528','P-191','P-528','P-188','P-528','P-189','P-528','P-001'], dur: 0.36 },
  // PH-023: 팔을 높이 올린 상태에서 X자로 교차 (고공 크로스)
  'PH-023': { name: '고공 X 크로스 안전', poses: ['P-002','P-194','P-528','P-196','P-192','P-200','P-192','P-194','P-002'], dur: 0.5 },
  // PH-024: 한 팔씩 강하게 안쪽으로 지르는 교차 타격 (점층적 강도)
  'PH-024': { name: '교차 타격 안전', poses: ['P-203','P-204','P-203','P-207','P-203','P-208','P-528','P-211','P-203','P-212','P-528','P-207','P-203','P-208'], dur: 0.34 },
  // PH-025: 한 팔이 대각선 위로 크게 스와이프 — 좌우 번갈아 (P-213~P-220 계열)
  'PH-025': { name: '대각선 스와이프',  poses: ['P-213','P-219','P-214','P-220','P-215','P-216','P-213','P-214'], dur: 0.6  },
    // ── 숏폼/케이팝/테크토닉 계열 신규 구 ─────────────────────────────
  // ── 숏폼/케이팝/테크토닉 계열 신규 구 ─────────────────────────────
  // PH-026: 닌자 인장처럼 가슴 앞에서 짧게 모으고, 좌우로 빠르게 분리되는 팝
  'PH-026': { name: '닌자 핸드사인 팝 안전', poses: ['P-181','P-184','P-192','P-186','P-527','P-187','P-192','P-190','P-184','P-528'], dur: 0.34 },
  // PH-027: 테크토닉 느낌의 각진 팔꿈치 박스 컷. 팔이 ㄱ자로 꺾이며 좌우 교차
  'PH-027': { name: '테크토닉 박스컷', poses: ['P-233','P-235','P-237','P-239','P-241','P-242','P-240','P-238','P-236','P-234'], dur: 0.34 },
  // PH-028: 와킹/아이돌 포즈처럼 팔 프레임을 만들고 반대편으로 넘기는 동작
  'PH-028': { name: '와킹 팔 프레임', poses: ['P-243','P-245','P-247','P-249','P-251','P-252','P-250','P-248','P-246','P-244'], dur: 0.36 },
  // PH-029: 쇼츠 챌린지식 손목 플릭. 작은 각도에서 빠르게 튕기며 포인트를 만듦
  'PH-029': { name: '숏폼 손목 플릭', poses: ['P-253','P-255','P-257','P-259','P-261','P-260','P-258','P-256','P-254','P-253'], dur: 0.28 },
  // PH-030: 팔꿈치 중심으로 안쪽 원을 그리는 사이버 롤. 테크토닉보다 부드러운 회전감
  'PH-030': { name: '사이버 엘보 롤', poses: ['P-263','P-265','P-267','P-269','P-271','P-272','P-270','P-268','P-266','P-264'], dur: 0.35 },
  // PH-031: 케이팝 포인트 안무처럼 한쪽 팔을 찍고 회수하는 락 앤 릴리즈
  'PH-031': { name: '아이돌 포인트 락', poses: ['P-283','P-285','P-287','P-289','P-291','P-292','P-290','P-288','P-286','P-284'], dur: 0.32 },
  // PH-032: 고공에서 번개처럼 꺾는 하이컷. 만세와 달리 한 팔씩 날카롭게 튐
  'PH-032': { name: '고공 번개 컷', poses: ['P-435','P-446','P-448','P-461','P-463','P-464','P-462','P-449','P-447','P-435'], dur: 0.42 },
  // PH-033: 머리 위에서 X와 다이아몬드 실루엣을 오가는 고각 드릴
  'PH-033': { name: '하이 X 드릴', poses: ['P-450','P-451','P-452','P-450','P-456','P-457','P-456','P-452','P-451','P-450'], dur: 0.38 },
  // PH-034: 좌우로 게걸음 치듯 팔만 셔플. 하체 없는 로봇에서 리듬감을 주기 좋음
  'PH-034': { name: '크랩 핸드 셔플', poses: ['P-303','P-305','P-307','P-309','P-311','P-313','P-315','P-313','P-311','P-309','P-307','P-305','P-303','P-304','P-306','P-308','P-310','P-312','P-314','P-316','P-314','P-312','P-310','P-308','P-306','P-304'], dur: 0.28 },
  // PH-035: 락킹/포인팅 계열. 한쪽 팔로 찍고 반대쪽 팔이 받는 빠른 투포인트 루프
  'PH-035': { name: '락킹 투포인트', poses: ['P-383','P-387','P-391','P-395','P-399','P-401','P-401','P-402','P-402','P-400','P-396','P-392','P-388','P-384','P-384','P-386','P-390','P-394','P-398','P-402','P-402','P-401','P-397','P-393','P-389','P-385','P-383'], dur: 0.34 },

  // ── 대형 변화 신규 구: 기존 26~35를 덮지 않는 확장형 ───────────────
  'PH-036': { name: '나루토 암 러시 안전', poses: ['P-169','P-170','P-528','P-171','P-172','P-528','P-173','P-172','P-528','P-171','P-170','P-169','P-528','P-174','P-175','P-176','P-528'], dur: 0.3 },
  'PH-037': { name: '스카이 슬래시 컷', poses: ['P-403','P-405','P-407','P-409','P-407','P-405','P-403','P-404','P-406','P-408','P-410','P-408','P-406','P-404'], dur: 0.36 },
  'PH-038': { name: '하이 X 드릴 롱', poses: ['P-419','P-421','P-423','P-425','P-427','P-429','P-433','P-429','P-427','P-425','P-423','P-421','P-419','P-420','P-422','P-424','P-426','P-428','P-430','P-434','P-430','P-428','P-426','P-424','P-422','P-420'], dur: 0.28 },
  'PH-039': { name: '테크토닉 리버스 체인', poses: ['P-242','P-240','P-238','P-236','P-234','P-233','P-235','P-237','P-239','P-241','P-239','P-237','P-235','P-233','P-234','P-236','P-238','P-240','P-242'], dur: 0.26 },
  'PH-040': { name: '와킹 프레임 체인', poses: ['P-243','P-245','P-247','P-249','P-251','P-252','P-250','P-248','P-246','P-244','P-243','P-244','P-246','P-248','P-250','P-252','P-251','P-249','P-247','P-245','P-243'], dur: 0.28 },
  'PH-041': { name: '아이돌 포인트 체인', poses: ['P-283','P-285','P-287','P-289','P-291','P-292','P-290','P-288','P-286','P-284','P-283','P-284','P-286','P-288','P-290','P-292','P-291','P-289','P-287','P-285','P-283'], dur: 0.27 },
  // ── 팝핀 + 애교 리액션 계열 수정 구: PH-042 ~ PH-068 ───────────────
  // PH-042: 양팔 정면 베이스에서 손목이 0 → 중간 → 피크 → 복귀로 커지는 기본 팝핀
  'PH-042': { name: '정면 팝핀 램프', poses: ['P-478','P-479','P-480','P-479','P-478','P-504'], dur: 0.20 },

  // PH-043: L7/R7 반대 결을 사용하는 반전 손목 팝. PH-042와 실루엣 대비용
  'PH-043': { name: '반전 손목 팝', poses: ['P-478','P-481','P-482','P-481','P-478','P-504'], dur: 0.20 },

  // PH-044: 빨간팔만 전방 팝핀. 파란팔은 P-001에 가까운 중립으로 유지
  'PH-044': { name: '빨간팔 단독 팝', poses: ['P-505','P-483','P-484','P-485','P-484','P-488','P-505'], dur: 0.19 },

  // PH-045: 파란팔만 전방 팝핀. 빨간팔은 P-001에 가까운 중립으로 유지
  'PH-045': { name: '파란팔 단독 팝', poses: ['P-505','P-489','P-490','P-491','P-490','P-494','P-505'], dur: 0.19 },

  // PH-046: 빨간팔 팝에서 파란팔 팝으로 넘어가는 전달형 구
  'PH-046': { name: '빨강→파랑 팝 전달', poses: ['P-505','P-484','P-485','P-495','P-478','P-490','P-491','P-496','P-505'], dur: 0.17 },

  // PH-047: 파란팔 팝에서 빨간팔 팝으로 넘어가는 반대 방향 전달형 구
  'PH-047': { name: '파랑→빨강 팝 전달', poses: ['P-505','P-490','P-491','P-496','P-478','P-484','P-485','P-495','P-505'], dur: 0.17 },

  // PH-048: 한쪽 팔만 앞으로 둔 상태에서 L2/R2 푸시풀을 넣어 손목만 움직이는 느낌을 탈피
  'PH-048': { name: '단손 푸시풀 팝', poses: ['P-505','P-487','P-501','P-488','P-505','P-493','P-502','P-494','P-505'], dur: 0.18 },

  // PH-049: 한쪽 팔은 중립, 한쪽 팔은 전방을 유지하며 손목 방향을 반전하는 대비 구
  'PH-049': { name: '원암 홀드 팝', poses: ['P-505','P-497','P-498','P-505','P-499','P-500','P-505'], dur: 0.19 },

  // PH-050: 양손 정면 히트. 너무 길지 않게 피크만 분명하게 사용
  'PH-050': { name: '더블 팝 히트', poses: ['P-478','P-479','P-503','P-508','P-503','P-481','P-478'], dur: 0.18 },

  // PH-051: 정면 팝핀에서 몸 안쪽 X크로스로 들어갔다가 완충 후 복귀
  'PH-051': { name: '팝핀 투 X크로스 안전', poses: ['P-505','P-479','P-480','P-528','P-169','P-192','P-172','P-192','P-175','P-176','P-528','P-505'], dur: 0.22 },

  // PH-052: 양손이 같은 쪽을 향하는 애교 포즈로 전환. 팝핀 뒤 분위기 전환용
  'PH-052': { name: '양손 애교 스위치', poses: ['P-505','P-528','P-509','P-510','P-527','P-511','P-512','P-527','P-505'], dur: 0.27 },

  // PH-053: 좌우 볼콕 느낌. 팝핀과 완전히 다른 귀여운 리액션 구
  'PH-053': { name: '볼콕 애교 루프', poses: ['P-528','P-517','P-509','P-527','P-518','P-511','P-527','P-528'], dur: 0.30 },

  // PH-054: 하트 준비 → 피크 → 릴리즈. 엔딩 포인트나 멘트 직후 사용
  'PH-054': { name: '미니 하트 엔딩', poses: ['P-528','P-519','P-523','P-524','P-523','P-520','P-527','P-528'], dur: 0.34 },

  // PH-055: 왼쪽으로 까딱, 오른쪽으로 까딱하며 양팔이 같은 방향을 바라보는 애교 동작
  'PH-055': { name: '좌우 까딱 애교', poses: ['P-527','P-525','P-517','P-525','P-527','P-526','P-518','P-526','P-527','P-528'], dur: 0.30 },

  // PH-056: 부끄러운 입가림 느낌에서 오픈으로 풀리는 리액션 동작
  'PH-056': { name: '부끄 입가림 리액션', poses: ['P-528','P-521','P-519','P-521','P-522','P-520','P-527','P-528'], dur: 0.34 },

  // PH-057: 양손이 한쪽 볼로 모였다가 반대 볼로 넘어가는 애교 스위치
  'PH-057': { name: '볼 스위치 애교', poses: ['P-527','P-509','P-510','P-513','P-527','P-514','P-511','P-512','P-527','P-528'], dur: 0.30 },

  // PH-058: 작은 하트 준비 → 피크 → 릴리즈. 엔딩 포인트나 효과음 직후 사용
  'PH-058': { name: '미니 하트 엔딩', poses: ['P-528','P-519','P-523','P-524','P-524','P-523','P-520','P-528'], dur: 0.36 },

  // PH-059: 애교 포즈에서 정면 팝핀으로 넘어가는 연결 동작
  'PH-059': { name: '애교 투 팝핀', poses: ['P-527','P-517','P-519','P-520','P-528','P-478','P-479','P-480','P-478'], dur: 0.24 },

  // PH-060: 정면 웰컴 느낌의 양팔 대칭 애교. 시작/인트로/인사 구간용
  'PH-060': { name: '웰컴 애교 체인', poses: ['P-528','P-513','P-514','P-527','P-517','P-518','P-519','P-520','P-527','P-528'], dur: 0.31 },

  // PH-061: 좌상향/우상향으로 양손이 같은 곳을 향하는 밝은 포인트 동작
  'PH-061': { name: '상향 애교 포인트', poses: ['P-527','P-515','P-509','P-515','P-527','P-516','P-511','P-516','P-527','P-528'], dur: 0.30 },

  // PH-062: 볼콕 → 하트 → 릴리즈까지 이어지는 비교적 긴 애교 종합 루프
  'PH-062': { name: '애교 종합 루프', poses: ['P-528','P-517','P-519','P-523','P-524','P-520','P-527','P-518','P-519','P-523','P-524','P-520','P-527','P-528'], dur: 0.25 },

  // ── 단손 팝핀 확장 구: 신규 포즈 없이 P-478~P-508 재활용 ─────────────────────────────
  'PH-063': { name: '빨간팔 원암 팝 루프', poses: ['P-505','P-483','P-484','P-485','P-484','P-486','P-488','P-505'], dur: 0.18 },
  'PH-064': { name: '파란팔 원암 팝 루프', poses: ['P-505','P-489','P-490','P-491','P-490','P-492','P-494','P-505'], dur: 0.18 },
  'PH-065': { name: '단손 팝 교대 체인', poses: ['P-505','P-484','P-485','P-495','P-478','P-490','P-491','P-496','P-478','P-497','P-498','P-499','P-500','P-505'], dur: 0.15 },
  'PH-066': { name: '단손 푸시풀 대비', poses: ['P-505','P-487','P-501','P-488','P-505','P-493','P-502','P-494','P-505'], dur: 0.18 },
  'PH-067': { name: '빨간팔 고정 파란 리듬', poses: ['P-497','P-498','P-497','P-490','P-491','P-490','P-496','P-478'], dur: 0.18 },
  'PH-068': { name: '파란팔 고정 빨강 리듬', poses: ['P-499','P-500','P-499','P-484','P-485','P-484','P-495','P-478'], dur: 0.18 },
};
...
window.clearTL = function() {
  ...
  _kfToTLRowIdx = [];
  _loopIteration = 0;
  // YAML import로 생성된 N-YML 포즈 정리 (다음 import 시 충돌 방지)
  _clearNYmlPoses();
