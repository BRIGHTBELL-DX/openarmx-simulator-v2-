...
const PHRASE_DB = {
  ...
  // PH-042: 가장 기본이 되는 정면 팝핀. 0값 베이스 → 손목 히트 → 릴리즈
  'PH-042': { name: '정면 팝핀 기본', poses: ['P-472','P-477','P-478','P-477','P-492'], dur: 0.22 },

  // PH-043: L7/R7 반전값을 활용한 반대 결 손목 팝. 기본 팝핀과 대비용
  'PH-043': { name: '반전 손목 팝', poses: ['P-472','P-493','P-494','P-493','P-492'], dur: 0.22 },

  // PH-044: 왼손만 튕기고 오른팔은 유지하는 단손 팝
  'PH-044': { name: '왼손 단독 팝', poses: ['P-472','P-484','P-485','P-484','P-492'], dur: 0.20 },

  // PH-045: 오른손만 튕기고 왼팔은 유지하는 단손 팝
  'PH-045': { name: '오른손 단독 팝', poses: ['P-472','P-486','P-487','P-486','P-492'], dur: 0.20 },

  // PH-046: 왼손에서 오른손으로 팝이 전달되는 연결 동작
  'PH-046': { name: '좌우 팝 전달', poses: ['P-472','P-484','P-488','P-486','P-489','P-492'], dur: 0.19 },

  // PH-047: 오른손에서 왼손으로 되돌아오는 반대 방향 전달 동작
  'PH-047': { name: '우좌 팝 전달', poses: ['P-472','P-486','P-489','P-484','P-488','P-492'], dur: 0.19 },

  // PH-048: L2/R2 변화로 팔 전체가 살짝 밀고 당겨지는 팝핀
  'PH-048': { name: '푸시풀 프론트 팝', poses: ['P-472','P-495','P-496','P-495','P-492'], dur: 0.22 },

  // PH-049: 좌우 단손 팝을 합친 뒤 양손 히트로 마무리하는 포인트 구
  'PH-049': { name: '단손 팝 합체', poses: ['P-472','P-484','P-485','P-486','P-487','P-490','P-491','P-492'], dur: 0.17 },

  // PH-050: 새로 추가한 팝핀 포즈를 중심으로 0값 베이스 → 준비 → 히트 → 리바운드 → 릴리즈
'PH-050': { name: '신규 팝핀 히트', poses: ['P-472','P-505','P-506','P-507','P-506','P-492'], dur: 0.20 },

  // PH-051: L7/R7 0값에서 시작해 손목 회전을 단계적으로 키웠다가 다시 풀어주는 정면 팝핀 기본구
  'PH-051': { name: '정면 팝핀 램프', poses: ['P-505','P-506','P-507','P-508','P-507','P-506','P-505'], dur: 0.18 },

  // PH-052: 베이스로 리셋하면서 손목 히트를 단계적으로 찍는 팝핀 리듬구
  'PH-052': { name: '정면 팝핀 스텝 히트', poses: ['P-505','P-506','P-505','P-507','P-505','P-508','P-507','P-506','P-505'], dur: 0.15 },

    // ── 애교/리액션 계열 신규 구: 양팔 같은 방향 포인트 / 볼콕 / 하트 / 까딱 ───────────────
  // PH-053: 좌우 볼 쪽으로 양손이 번갈아 모이는 애교 루프. 너무 빠르지 않게 리셋 포함
  'PH-053': { name: '볼콕 애교 루프', poses: ['P-527','P-509','P-517','P-510','P-527','P-511','P-518','P-512','P-527','P-528'], dur: 0.28 },

  // PH-054: 양손이 볼하트처럼 모였다가 작게 풀리는 귀여운 정면 포인트
  'PH-054': { name: '볼하트 포인트', poses: ['P-527','P-519','P-523','P-524','P-523','P-520','P-527','P-528'], dur: 0.32 },
